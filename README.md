...
$ npx tsx scripts/measure-fps-and-heap/index.ts --headed --video-file scripts/generate-fake-camera-video/videos/noise_640x480_30fps.y4m    # 生成したノイズ動画を疑似カメラ映像として使って計測
$ npx tsx scripts/capture-trace/index.ts                    # FPS低下の遷移が起きる区間のCDPトレースを取得(trace.json)
$ npx tsx scripts/capture-trace/index.ts --video-file scripts/generate-fake-camera-video/videos/noise_640x480_30fps.y4m    # 同上、ノイズ動画を使って計測
